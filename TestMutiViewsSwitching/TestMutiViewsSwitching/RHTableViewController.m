...
- (void)viewDidLoad {
    ...
    _tableViewItems = @[
                         [[RHTableViewItem alloc] initWithTitle:@"push/pop" className:@"RHPushAndPopViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"modal" className:@"RHModalViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"rootViewController" className:@"RHRootViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"addChildViewController" className:@"RHAddChildViewController"],
                         ];
