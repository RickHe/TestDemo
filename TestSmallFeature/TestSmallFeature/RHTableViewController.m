...
- (void)viewDidLoad {
    ...
    _tableViewItems = @[
                         [[RHTableViewItem alloc] initWithTitle:@"打电话" className:@"RHPhoneCallViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"发短信" className:@"RHSendMessageViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"发邮件" className:@"RHSendEmailViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"打开微信" className:@"RHJumpToApplicationViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"打开 App Store 评分" className:@"RHApplicationStarViewController"],
                         ];
